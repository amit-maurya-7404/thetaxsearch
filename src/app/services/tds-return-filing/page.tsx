  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-800">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl font-bold text-slate-900">Complete TDS Management Services</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <ServiceCard 
              ...
              desc="Accurate TDS computation across all sections (194J, 194LA, 194C) for employees and vendors."
            />
            <ServiceCard 
              icon={<BarChart3 className="w-8 h-8 text-indigo-600" />}
              title="Return Filing"
              desc="Timely quarterly TDS return filing (24Q, 26Q) with complete reconciliation."
            />
            <ServiceCard 
              icon={<TrendingUp className="w-8 h-8 text-cyan-600" />}
              title="Challan Management"
              desc="Challan generation, deposition, and reconciliation with IT department."
            />
            <ServiceCard 
              icon={<ShieldCheck className="w-8 h-8 text-rose-600" />}
              title="Certificate & Compliance"
              desc="TDS certificate generation and complete statutory compliance support."
            />
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              ...
              <p className="text-slate-600 mb-8 leading-relaxed">
                Our TDS experts ensure timely filings and accurate reconciliations, reducing compliance risks and IT department notices.
              </p>
              <div className="space-y-4">
                <FeatureItem text="Timely quarterly filing & zero penalties" />
                <FeatureItem text="Challan reconciliation expertise" />
                <FeatureItem text="Professional notice handling" />
              </div>
            </div>
            ...
            <div className="lg:w-1/2 w-full">
              <div className="bg-white p-8 rounded-2xl shadow-xl border border-slate-100">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900">TDS Specialist</h4>
                    <p className="text-sm text-slate-500">Dedicated expert support</p>
                  </div>
                </div>
                ...
                <div className="mt-4 flex justify-between text-sm">
                  ...
                  <span className="font-bold text-primary">99% Compliant</span>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-slate-900">Our Engagement Process</h2>
            <p className="text-slate-600 mt-2">How we manage your TDS compliance</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
            ...
            <Step 
              number="01"
              title="Collection"
              desc="Gather all TDS related data and transactions."
            />
            <Step 
              number="02"
              title="Compute"
              desc="Calculate TDS accurately for all deductees."
            />
            <Step 
              number="03"
              title="File"
              desc="Submit quarterly returns and challans on time."
            />
            <Step 
              number="04"
              title="Reconcile"
              desc="Match and reconcile with IT department records."
            />
          </div>
        </div>
      </section>
      ...
      {/* <section className="py-16 bg-slateDark text-white text-center">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold mb-4">Ensure TDS compliance effortlessly</h2>
          <p className="text-emerald-200 mb-8 max-w-2xl mx-auto">Let our TDS experts handle all filings and reconciliations so you stay audit-ready.</p>
