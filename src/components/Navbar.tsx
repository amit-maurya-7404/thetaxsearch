        ...
        <div className="md:hidden border-t bg-white/40 backdrop-blur-md border-white/20 shadow-lg">
          <div className="container max-w-7xl mx-auto px-4 py-3">
            <div className="space-y-1">
              ...
              <Link href="/calculators" onClick={() => setIsOpen(false)} className="block px-4 py-3 text-sm font-medium text-black hover:bg-primary/10 hover:text-primary rounded-lg transition-all duration-200">
                Calculators
              </Link>
